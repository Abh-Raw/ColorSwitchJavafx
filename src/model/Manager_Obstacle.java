...
public class Manager_Obstacle {
    ...
    public void createManagerObstacle(float x, float y){
        ...
        Arc arc9 = new Arc(x, y, 180.0f, 180.0f, 0-45, 90);  //arc(center_x, center_y, radius_x, radius_y, start_angle, set_length)
        Arc arc10 = new Arc(x, y, 180.0f, 180.0f, 90-45, 90);
        Arc arc11 = new Arc(x, y, 180.0f, 180.0f, 180-45, 90);
        Arc arc12 = new Arc(x, y, 180.0f, 180.0f, 270-45, 90);
    ...
    public void addAnimation(float x, float y, AnchorPane gp){
        ...
        rotation9.pivotXProperty().bind(arc_components.get(4).centerXProperty());
        rotation9.pivotYProperty().bind(arc_components.get(4).centerYProperty());
        rotation10.pivotXProperty().bind(arc_components.get(5).centerXProperty());
        rotation10.pivotYProperty().bind(arc_components.get(5).centerYProperty());
        rotation11.pivotXProperty().bind(arc_components.get(6).centerXProperty());
        rotation11.pivotYProperty().bind(arc_components.get(6).centerYProperty());
        rotation12.pivotXProperty().bind(arc_components.get(7).centerXProperty());
        rotation12.pivotYProperty().bind(arc_components.get(7).centerYProperty());
        ...
        KeyValue arc9_val1 = new KeyValue(rotation9.angleProperty(), 0);
        KeyValue arc9_val2 = new KeyValue(rotation9.angleProperty(), 90);
        KeyValue arc9_val3 = new KeyValue(rotation9.angleProperty(), 180);
        KeyValue arc9_val4 = new KeyValue(rotation9.angleProperty(), 270);
        KeyValue arc9_val5 = new KeyValue(rotation9.angleProperty(), 360);

        KeyValue arc10_val1 = new KeyValue(rotation10.angleProperty(), 0);
        KeyValue arc10_val2 = new KeyValue(rotation10.angleProperty(), 90);
        KeyValue arc10_val3 = new KeyValue(rotation10.angleProperty(), 180);
        KeyValue arc10_val4 = new KeyValue(rotation10.angleProperty(), 270);
        KeyValue arc10_val5 = new KeyValue(rotation10.angleProperty(), 360);

        KeyValue arc11_val1 = new KeyValue(rotation11.angleProperty(), 0);
        KeyValue arc11_val2 = new KeyValue(rotation11.angleProperty(), 90);
        KeyValue arc11_val3 = new KeyValue(rotation11.angleProperty(), 180);
        KeyValue arc11_val4 = new KeyValue(rotation11.angleProperty(), 270);
        KeyValue arc11_val5 = new KeyValue(rotation11.angleProperty(), 360);

        KeyValue arc12_val1 = new KeyValue(rotation12.angleProperty(), 0);
        KeyValue arc12_val2 = new KeyValue(rotation12.angleProperty(), 90);
        KeyValue arc12_val3 = new KeyValue(rotation12.angleProperty(), 180);
        KeyValue arc12_val4 = new KeyValue(rotation12.angleProperty(), 270);
        KeyValue arc12_val5 = new KeyValue(rotation12.angleProperty(), 360);
